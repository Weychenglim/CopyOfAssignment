...
public class ListHistoryFragmentIncome extends ListHistoryFragment{
    ...
    protected void loadData(int year, int month, int day) {
        ...
        this.month = month;
        this.day=day;
        List<AccountItem> list = DBManager.getAccountListOneDayFromAccounttbType(year,month,day,1);
        mDatas.clear();
        mDatas.addAll(list);
