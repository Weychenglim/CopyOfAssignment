package com.example.copyofassignment.db;
...
public class DBManager {
    ...
    public static void initDB(Context context) {
        ...
        db = helper.getEncryptedDatabase("FinTrack");
    }
    ...
    public static void deleteAllRecord(Context context){
        ...
        db.execSQL(sql);
        sql = "delete from savingtb";
        db.execSQL(sql);
        sql = "delete from savingtransactiontb";
        db.execSQL(sql);

        SharedPreferences preferences = context.getSharedPreferences("BudgetPrefs", Context.MODE_PRIVATE);
